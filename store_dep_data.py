...
for zone in zonelist:
	...
	anal.store_zone_sensors(zone, datetime(2015,10,14,3,20),datetime(2015,10,14,4,30), 'nextval', 'data/dep/dep_dc_'+zone.replace('RM-','')+'_1013.pkl')
...
for zone in zonelist:
	anal.store_zone_sensors(zone, datetime(2015,10,16,20,30),datetime(2015,10,16,22,10), 'nextval', 'data/dep/dep_cs_'+zone.replace('RM-','')+'_1016.pkl')
	anal.store_zone_sensors(zone, datetime(2015,10,16,22,14),datetime(2015,10,17,1,10), 'nextval', 'data/dep/dep_oc_'+zone.replace('RM-','')+'_1016.pkl')
	anal.store_zone_sensors(zone, datetime(2015,10,17,1,10),datetime(2015,10,17,4,25), 'nextval', 'data/dep/dep_cc_'+zone.replace('RM-','')+'_1016.pkl')
